import vk_api
import datetime
from database_lib.add_inf_db import SqlDataPersons
...
class VkSearcher:
    def __init__(self, token, user_id_num):
        ...
        self.id = user_id_num
        self.database = SqlDataPersons(db_name)
    ...
    def _get_user_info(self):
        ...
        user_data = dict(
            ...
            personurl=f"https://vk.com/id{self.id}",
            age=user_age if user_age < 100 else 18,
